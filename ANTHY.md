...
- **Roadmap reorganizado (BIT-32 auditoría + BIT-33 roadmap, 30 Jul 2026):** Ver BIT-33 en Notion para el plan maestro completo. Próximos módulos: BIT-08 (Visitas), BIT-09 (Observaciones de Campo), BIT-10 (Atenciones Clínicas), BIT-13/14/15 (ciclo de vida de Atención Clínica), BIT-12/16/17 (informe diario + WhatsApp). BIT-11 (Personas) **no es bloqueante** — Tutor Responsable se crea inline en el formulario de Paciente Animal.

---
*Mantenido por Anthy. Última actualización: 6 Ago 2026 — BIT-07 cerrado, módulo Pacientes Animales y Lotes implementado. Entidad "Novedades del Establecimiento" anotada para considerar en el futuro.*
